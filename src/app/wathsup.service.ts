...
private readonly url = 'https://www.waboxapp.com/api/send/chat';
 ...
 sendmessage(number, testo): Observable<any> {
   ...
   return this.http.post( this.url, {}, {
     params: new HttpParams().set('token', '30c58c744a12ef74b365686b243bec9a5a240c87e974e').set('uid', '393200771189').set('to', number).set('text', testo).set('custom_uid', 'test' + (Math.random() * 100) )
   });
 }
}
